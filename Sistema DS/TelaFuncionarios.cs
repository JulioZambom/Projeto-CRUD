    ...
    public partial class TelaFuncionarios : Form
    {
        ...
        private void btncadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql_insert = @"insert into tb_funcionarios (tb_funcionarios_nome, tb_funcionarios_rg, tb_funcionarios_cpf,tb_funcionarios_email,tb_funcionarios_senha,tb_funcionarios_cargo,
                                                                  tb_funcionarios_nivel_acesso, tb_funcionarios_telefone, tb_funcionarios_celular, tb_funcionarios_cep, tb_funcionarios_endereco,
                                                                  tb_funcionarios_numero, tb_funcionarios_complemento, tb_funcionarios_bairro, tb_funcionarios_cidade, tb_funcionarios_estado)
        ...
        private void btnatualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlConnection con = new MySqlConnection(conexao);
                con.Open();
                string sql_update_funcionario = @"update tb_funcionarios set tb_funcionarios_nome = @nome,  tb_funcionarios_rg = @rg, tb_funcionarios_cpf = @cpf, tb_funcionarios_email = @email,
                                                                  tb_funcionarios_senha = @senha,  tb_funcionarios_cargo = @cargo,  tb_funcionarios_nivel_acesso = @nivel, tb_funcionarios_telefone = @telefone,
                                                                  tb_funcionarios_celular = @celular,  tb_funcionarios_cep = @cep,  tb_funcionarios_endereco = @endereco,  tb_funcionarios_numero = @numero,
                                                                  tb_funcionarios_complemento = @complemento, tb_funcionarios_bairro = @bairro, tb_funcionarios_cidade = @cidade, tb_funcionarios_estado = @estado";
                ...
                MessageBox.Show("Funcionario atualizado com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void btnexcluir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DialogResult dr2 = MessageBox.Show("Quer realmente excluir esse registro?", "Atenção", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void DgvListaFuncionarios_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtniveldeacesso.Text = DgvListaFuncionarios.CurrentRow.Cells[7].Value.ToString();
