    ...
    public partial class TelaFornecedores : Form
    {
        ...
        private void btncadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql_insert = @"insert into tb_fornecedores(tb_fornecedores_nome, tb_fornecedores_cnpj,tb_fornecedores_email, tb_fornecedores_telefone,tb_fornecedores_celular,
                                                                  tb_fornecedores_cep, tb_fornecedores_endereco, tb_fornecedores_numero, tb_fornecedores_complemento,
                                                                  tb_fornecedores_bairro, tb_fornecedores_cidade, tb_fornecedores_estado )
                ...
                // fechar conexao
                con.Close();
                MessageBox.Show("O fornecedor foi cadastrado com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void btnatualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql_update_fornecedores = @"update tb_fornecedores set tb_fornecedores_nome = @nome, tb_fornecedores_cnpj = @cnpj, tb_fornecedores_email = @email,
                                                                  tb_fornecedores_telefone = @telefone, tb_fornecedores_celular = @celular, tb_fornecedores_cep = @cep,
                                                                  tb_fornecedores_endereco = @endereco, tb_fornecedores_numero = @numero,tb_fornecedores_complemento = @complemento,tb_fornecedores_bairro = @bairro,
                                                                  tb_fornecedores_cidade = @cidade,tb_fornecedores_estado = @estado where tb_fornecedores_id = @id";
                ...
                con.Close();
                MessageBox.Show("Fornecedor atualizado com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void DgvListaFornecedores_CellClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnexcluir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DialogResult dr2 = MessageBox.Show("Tem certeza que deseja excluir?", "Atenção", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            {
                string mensagem = "Occoreu o erro: " + erro;
                MessageBox.Show(mensagem, "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
